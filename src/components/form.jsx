...
// Visually represents the urgency of the task
const UrgencySlider = (urgency) => {
  const [urgencyLevel, setUrgencyLevel] = useState(0); // Set default level to Trivial
  useEffect(() => {
    ...
    <div>
      ...
      >
        <div className="flex flex-col">
          <label htmlFor="task" className="mb-2 font-bold">
            Task:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <option className="text-black" value="absurd">
              Absurd
            </option>
            <option className="text-black" value="scientific">
              Scientific
            </option>
            <option className="text-black" value="emotional">
              Emotional
            </option>
          </select>
        </div>
      ...
      {/* Loading State */}
      {loading && (
        <div className="mt-8 text-lg font-bold animate-pulse">Loading...</div>
      )}
      ...
      {results && (
        <div>
          ...
          <p className="text-4xl font-bold mt-4 mb-5 text-shadow text-center">
            urgency of task:{" "}
            <span className="text-decoration-underline underline">
              {results.urgency}
            </span>
          </p>
